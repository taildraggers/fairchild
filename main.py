"""Scrape Fairchild listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Fairchild Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=fairchild&s-original-search=fairchild",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=fairchild"),
    ("ASO", "https://aso.com/search?q=Fairchild"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Fairchild Listings</h2>
    <p>View additional Fairchild Aircraft listings at these fine sites:</p>
